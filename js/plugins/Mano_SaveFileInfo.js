 ...
 * @author しぐれん
 * @url https://github.com/Sigureya/RPGmakerMZ/blob/master/Mano_SaveFileInfo.js
 * @target MZ
...
function createContentsSpriteList(spriteList){
    ...
    const sp2= spriteV2.map( (text)=>{
        const obj =JSON.parse(text);
        console.log(obj);
        const rect =new Rectangle( Number(obj.x),Number(obj.y),Number(220),Number(obj.height));
